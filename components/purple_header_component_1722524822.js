...
Vue.component("purple_header_component_1722524822", {
    template: `
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav id="desktop-navigation" class="hidden md:flex md:grow">
                    ...
                    <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                        <li><a id="Find Your Match-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" :class="[textStylePrimary, hoverTextStylePrimary]" href="Find Your Match.html">Find Your Match</a></li>
                        <li><a id="Dating in Madrid-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Dating in Madrid.html" :class="[textStylePrimary, hoverTextStylePrimary]">Dating in Madrid</a></li>
                        <li><a id="Success Stories-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Success Stories.html" :class="[textStylePrimary, hoverTextStylePrimary]">Success Stories</a></li>
                        <li><a id="Safety Tips-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Safety Tips.html" :class="[textStylePrimary, hoverTextStylePrimary]">Safety Tips</a></li>
                        <li><a id="Blog-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Blog.html" :class="[textStylePrimary, hoverTextStylePrimary]">Blog</a></li>
                    </ul>
                ...
                <div id="mobile-menu" class="md:hidden flex items-center ml-4" x-data="{ expanded: false }">
                    ...
                    <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" :style="expanded ? 'max-height: ' + $refs.mobileNav.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: .8'" @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>
                        <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5" :class="signUpButtonGradient">
                            <li><a id="mobile-Find Your Match-link" class="flex font-medium text-sm py-1.5" href="Find Your Match.html" :class="[textStylePrimary,hoverTextStylePrimary]">Find Your Match</a></li>
                            <li><a id="mobile-Dating in Madrid-link" class="flex font-medium text-sm py-1.5" href="Dating in Madrid.html" :class="[textStylePrimary,hoverTextStylePrimary]">Dating in Madrid</a></li>
                            <li><a id="mobile-Success Stories-link" class="flex font-medium text-sm py-1.5" href="Success Stories.html" :class="[textStylePrimary,hoverTextStylePrimary]">Success Stories</a></li>
                            <li><a id="mobile-Safety Tips-link" class="flex font-medium text-sm py-1.5" href="Safety Tips.html" :class="[textStylePrimary,hoverTextStylePrimary]">Safety Tips</a></li>
                            <li><a id="mobile-Blog-link" class="flex font-medium text-sm py-1.5" href="Blog.html" :class="[textStylePrimary,hoverTextStylePrimary]">Blog</a></li>
                        </ul>
                    </nav>
